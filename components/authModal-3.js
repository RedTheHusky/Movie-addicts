class authModal {
	...
	add2Head(options={}){
		...
		let me=this;
		script['recaptcha'].src = "https://www.google.com/recaptcha/api.js?onload=displayNewUserButton&render=explicit";  
		...
		/*script['modal'].src = "../components/Modal.js";  
		document.head.appendChild(script['modal']);  
		if (script['modal'].addEventListener) {
			script['moda'].addEventListener('load', function() {
				console.log("script Done modal");
			}, false);   
		};*/  
		/*script['auth'].src = "../models/Auth.js";  
		document.head.appendChild(script['auth']);  
		if (script['auth'].addEventListener) {
			script['auth'].addEventListener('load', function() {
				console.log("script Done modal");
			}, false);   
		}
		script['authregister'].src = "../models/AuthRegister.js";  
		document.head.appendChild(script['authregister']);  
		if (script['authregister'].addEventListener) {
			script['authregister'].addEventListener('load', function() {
				console.log("script Done modal");
			}, false);   
		}
		script['storage'].src = "../models/Storage.js";  
		document.head.appendChild(script['storage']);  
		if (script['storage'].addEventListener) {
			script['storage'].addEventListener('load', function() {
				console.log("script Done modal");
			}, false);   
		}*/
		console.groupEnd();		
	...
	recaptchaError(){
		console.groupCollapsed('recaptchaError');
		console.groupEnd();
	}
	getURLDatas(){
